...
Covers the capability + behavioral scoring path (candidate input, ontology, JD
rubric, capability profile, capability fit, behavioral profile). Honeypot,
ranking and submission models are added as their modules land.
"""
